...
export const SYNDROMES_TRISOMY = [
  {
    ...
    diagnosticTest:'Karyotype (47,XX,+21 or 47,XY,+21) or chromosomal microarray',
    keyOrganism:'',
    organismOptions:[],
    ...
    keyComplication:'Increased risk of ALL/AMKL; early-onset Alzheimer disease (APP overexpression on chromosome 21)',
  ...
  },
  {
    ...
    diagnosticTest:'Karyotype (47,XX,+18 or 47,XY,+18)',
    keyOrganism:'',
    organismOptions:[],
    ...
    keyComplication:'~90% mortality in first year from cardiac and respiratory complications',
  ...
  },
  {
    ...
    diagnosticTest:'Karyotype (47,XX,+13 or 47,XY,+13)',
    keyOrganism:'',
    organismOptions:[],
    ...
    keyComplication:'~90% mortality in first year from severe CNS and cardiac malformations',
  ...
  },
  {
    ...
    defect:'Loss of maternally-expressed UBE3A (15q11-q13) — paternal allele silenced by imprinting in neurons',
    ...
    diagnosticTest:'DNA methylation analysis at 15q11-q13 imprinting center; chromosomal microarray for maternal deletion',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Refractory seizures with characteristic high-amplitude 2–3 Hz slow-wave EEG pattern (onset before age 3)',
    complicationOptions:[
  ...
  },
  {
    ...
    pmhPool: PEDIATRIC_PMH, shxPool: PEDIATRIC_SHX,
    defect:'Loss of paternally-expressed 15q11-q13 genes (SNRPN, MAGEL2, NDN) — maternal allele silenced by imprinting',
    ...
    diagnosticTest:'DNA methylation analysis at 15q11-q13 imprinting center; chromosomal microarray for paternal deletion',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Severe childhood obesity from hyperphagia (→ type 2 diabetes, obstructive sleep apnea)',
    complicationOptions:[
      'Severe obesity from hyperphagia (type 2 diabetes, obstructive sleep apnea)',
  ...
  },
  {
    ...
    defect:'Extra X chromosome (47,XXY) from meiotic nondisjunction — seminiferous tubule hyalinization, hypergonadotropic hypogonadism',
    ...
    diagnosticTest:'Karyotype (47,XXY)',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Breast cancer (~50× increased risk); mediastinal nonseminomatous germ cell tumors',
    complicationOptions:[
      'Breast cancer (~50× risk) and mediastinal germ cell tumors',
  ...
  },
  {
    ...
    pmhPool: ADOLESCENT_PMH, shxPool: ADOLESCENT_SHX,
    defect:'Monosomy X (45,X) — SHOX haploinsufficiency (short stature); streak ovaries, hypergonadotropic hypogonadism',
    ...
    diagnosticTest:'Karyotype (45,X or 45,X/46,XX mosaic)',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'Bicuspid aortic valve with or without preductal coarctation of the aorta',
    cardiacOptions:[
    ...
    keyComplication:'Aortic dissection in adulthood (~6× risk), especially with bicuspid valve or coarctation',
    complicationOptions:[

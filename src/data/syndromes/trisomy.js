...
export const SYNDROMES_TRISOMY = [
  {
    ...
    diagnosticTest:'Karyotype',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'Complete AV septal defect',
    cardiacOptions:['Complete AV septal defect','Ventricular septal defect','Atrial septal defect','Patent ductus arteriosus','Tetralogy of Fallot'],
    keyComplication:'Increased risk of leukemia and early-onset Alzheimer disease',
    complicationOptions:['Increased risk of leukemia and early-onset Alzheimer disease','Duodenal atresia','Hirschsprung disease','Congenital hypothyroidism','Atlantoaxial instability'],
    cc: () => rand([
  ...
  },
  {
    ...
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'Ventricular septal defect',
    cardiacOptions:['Ventricular septal defect','Atrial septal defect','Patent ductus arteriosus','Complete AV septal defect','Tetralogy of Fallot'],
    keyComplication:'90% mortality in the first year',
    complicationOptions:['90% mortality in the first year','Horseshoe kidney','Omphalocele','Severe intellectual disability in survivors','Recurrent apneic episodes'],
    cc: () => rand([
  ...
  },
  {
    ...
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'Ventricular septal defect with dextrocardia',
    cardiacOptions:['Ventricular septal defect with dextrocardia','Atrial septal defect','Patent ductus arteriosus','Complete AV septal defect','Hypoplastic left heart syndrome'],
    keyComplication:'90% mortality in the first year',
    complicationOptions:['90% mortality in the first year','Holoprosencephaly with seizures','Severe intellectual disability in survivors','Omphalocele complications','Apneic episodes'],
    cc: () => rand([
  ...
  },
  {
    ...
    diagnosticTest:'DNA methylation analysis at 15q11-q13',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Refractory seizures with characteristic EEG pattern',
    complicationOptions:[
      'Refractory seizures with characteristic EEG pattern',
      'Hyperphagia with childhood obesity',
  ...
  },
  {
    ...
    pmhPool: PEDIATRIC_PMH, shxPool: PEDIATRIC_SHX,
    defect:'Loss of paternal 15q11-q13 genes',
    ...
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Severe obesity from hyperphagia',
    complicationOptions:[
      'Severe obesity from hyperphagia',
      'Refractory seizures with characteristic EEG pattern',
      'Aortic dissection in early adulthood',
      'Acute lymphoblastic leukemia',
      'Mediastinal germ cell tumor'
    ],
    cc: () => rand([
  ...
  },
  {
    ...
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Breast cancer and mediastinal germ cell tumors',
    complicationOptions:[
      'Breast cancer and mediastinal germ cell tumors',
      'Aortic dissection in adulthood',
      'Acute lymphoblastic leukemia',
      'Renal cell carcinoma',
      'Refractory seizures with hand-flapping'
    ],
    cc: () => rand([
  ...
  },
  {
    ...
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'Bicuspid aortic valve with coarctation',
    cardiacOptions:[
    ...
    keyComplication:'Aortic dissection in adulthood',
    complicationOptions:[
      'Aortic dissection in adulthood',
      'Breast cancer and mediastinal germ cell tumors',
      'Acute lymphoblastic leukemia',

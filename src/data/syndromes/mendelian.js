...
export const SYNDROMES_MENDELIAN = [
  {
    ...
    defect:'CFTR loss-of-function (chromosome 7q31.2) — defective apical chloride channel; ΔF508 most common',
    ...
    diagnosticTest:'Sweat chloride ≥60 mEq/L (pilocarpine iontophoresis); confirmatory CFTR mutation analysis',
    keyOrganism:'Pseudomonas aeruginosa (chronic mucoid colonization)',
    organismOptions:[
    ...
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Exocrine pancreatic insufficiency (steatorrhea, fat-soluble vitamin A/D/E/K deficiency)',
    complicationOptions:[
      'Exocrine pancreatic insufficiency and fat-soluble vitamin deficiency',
      ...
      'Coarse facial features with corneal clouding and dysostosis multiplex',
      'Spontaneous aortic or coronary dissection'
    ],
    cc: () => rand([
  ...
  },
  {
    ...
    pmhPool: PEDIATRIC_PMH, shxPool: PEDIATRIC_SHX,
    defect:'α-L-iduronidase deficiency (IDUA, chromosome 4p16) — dermatan + heparan sulfate accumulation',
    ...
    diagnosticTest:'Leukocyte α-L-iduronidase enzyme activity assay; urine GAG analysis (elevated dermatan + heparan sulfate)',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'Progressive mitral and aortic valve thickening (regurgitation)',
    cardiacOptions:[
      'Progressive mitral and aortic valve thickening (regurgitation)',
      'Concentric hypertrophic cardiomyopathy',
      'Bicuspid aortic valve with preductal coarctation of the aorta',
      'Complete atrioventricular septal defect',
      'Spontaneous medium-vessel arterial dissection'
    ],
    keyComplication:'Death from cardiorespiratory failure by end of the first decade (untreated)',
    complicationOptions:[
  ...
  },
  {
    ...
    pmhPool: PEDIATRIC_PMH, shxPool: PEDIATRIC_SHX,
    defect:'Iduronate-2-sulfatase deficiency (IDS, Xq28) — only X-linked MPS; dermatan + heparan sulfate accumulation',
    ...
    diagnosticTest:'Leukocyte iduronate-2-sulfatase enzyme activity assay (α-L-iduronidase is normal)',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'Progressive mitral and aortic valve thickening (regurgitation)',
    cardiacOptions:[
    ...
    keyComplication:'Progressive mixed hearing loss with behavioral aggression and hyperactivity',
    complicationOptions:[
      'Progressive mixed hearing loss with aggression and hyperactivity',
  ...
  },
  {
    ...
    defect:'COL5A1 (or COL5A2) haploinsufficiency — reduced type V collagen, impaired fibrillogenesis',
    ...
    diagnosticTest:'2017 clinical criteria (skin hyperextensibility, atrophic scarring, joint hypermobility) + COL5A1/COL5A2 sequencing',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Recurrent joint dislocations and subluxations with chronic musculoskeletal pain',
    complicationOptions:[
      'Recurrent joint dislocations and subluxations with chronic musculoskeletal pain',
      'Spontaneous arterial rupture or sigmoid colon perforation in young adulthood',
  ...
  },
  {
    ...
    pmhPool: RH_PMH, shxPool: RH_SHX,
    defect:'COL3A1 dominant-negative mutation — structurally abnormal type III collagen, vascular and visceral fragility',
    ...
    diagnosticTest:'COL3A1 targeted sequencing (confirmatory); skin fibroblast electron microscopy for collagen fibril abnormalities',
    keyOrganism:'',
    organismOptions:[],
    keyCardiac:'',
    cardiacOptions:[],
    keyComplication:'Spontaneous arterial rupture, sigmoid colon perforation, or uterine rupture in pregnancy (leading causes of death before age 40)',
    complicationOptions:[
      'Spontaneous arterial rupture, sigmoid colon perforation, or uterine rupture during pregnancy',

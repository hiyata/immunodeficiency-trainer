...
export const SYNDROMES_HEME = [
  // -------------------------- AML --------------------------
  {
    ...
    defect:'Clonal myeloblast expansion',
    ...
    diagnosticTest:'Bone marrow biopsy; cytogenetics',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'DIC in APL, treated with ATRA',
    complicationOptions:[
      'DIC in APL, treated with ATRA',
  ...
  // -------------------------- ALL --------------------------
  {
    ...
    defect:'Clonal lymphoblast expansion',
    ...
    diagnosticTest:'Bone marrow biopsy with TdT staining',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Tumor lysis syndrome at chemotherapy initiation',
    complicationOptions:[
      'Tumor lysis syndrome at chemotherapy initiation',
      'DIC in APL, treated with ATRA',
      'Richter transformation to diffuse large B-cell lymphoma',
      'Aquagenic pruritus from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein'
    ],
    cc: () => rand([
  ...
  // -------------------------- CML --------------------------
  {
    ...
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'BCR-ABL1 tyrosine kinase',
    ...
    diagnosticTest:'FISH or PCR for BCR-ABL1',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Blast crisis',
    complicationOptions:[
      'Blast crisis evolving to acute leukemia',
      'Richter transformation to diffuse large B-cell lymphoma',
      'Tumor lysis syndrome at chemotherapy initiation',
  ...
  // -------------------------- CLL --------------------------
  {
    ...
    defect:'Clonal CD5+ B-cell expansion',
    ...
    diagnosticTest:'Peripheral blood flow cytometry',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Richter transformation to diffuse large B-cell lymphoma',
    complicationOptions:[
      'Richter transformation to diffuse large B-cell lymphoma',
      'Warm AIHA and immune thrombocytopenia',
      'Tumor lysis syndrome at chemotherapy initiation',
      'DIC in APL, treated with ATRA',
      'Aquagenic pruritus from JAK2 V617F'
    ],
  ...
  // -------------------------- Hairy Cell Leukemia --------------------------
  {
    ...
    diagnosticTest:'Bone marrow biopsy; BRAF V600E testing',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Pancytopenia from marrow infiltration',
    complicationOptions:[
  ...
  // -------------------------- Burkitt Lymphoma --------------------------
  {
    ...
    diagnosticTest:'Excisional biopsy; FISH for t(8;14)',
    ...
    keyComplication:'Spontaneous tumor lysis syndrome',
    complicationOptions:[
  ...
  // -------------------------- Hodgkin Lymphoma --------------------------
  {
    ...
    diagnosticTest:'Excisional biopsy for Reed-Sternberg cells',
    keyOrganism:'Epstein-Barr virus',
    ...
    keyComplication:'B symptoms and Ann Arbor staging',
    complicationOptions:[
      'B symptoms and Ann Arbor staging',
  ...
  // -------------------------- DLBCL --------------------------
  {
    ...
    pmhPool: ELDERLY_PMH, shxPool: ELDERLY_SHX,
    defect:'Clonal large CD20+ B-cell expansion',
    ...
    diagnosticTest:'Excisional biopsy; FISH for MYC/BCL2/BCL6',
    keyOrganism:'',
    organismOptions:['Epstein-Barr virus','Human T-lymphotropic virus type 1 (HTLV-1)','Human herpesvirus 8 (HHV-8 / KSHV)','Helicobacter pylori'],
    keyComplication:'Transformation from an indolent lymphoma',
    complicationOptions:[
  ...
  // -------------------------- Follicular Lymphoma --------------------------
  {
    ...
    diagnosticTest:'Excisional biopsy; FISH for t(14;18)',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Histologic transformation to DLBCL',
    complicationOptions:[
  ...
  // -------------------------- Mantle Cell Lymphoma --------------------------
  {
    ...
    diagnosticTest:'Excisional biopsy; FISH for t(11;14)',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Lymphomatous polyposis',
    complicationOptions:[
  ...
  // -------------------------- MALT Lymphoma --------------------------
  {
    ...
    sex:'any', ageMin:45, ageMax:75,
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'Antigen-driven marginal-zone B-cell lymphoma',
    ...
    diagnosticTest:'Endoscopic biopsy; H. pylori testing',
    ...
    keyComplication:'Failure to regress with H. pylori eradication',
    complicationOptions:[
      'Failure to regress with H. pylori eradication',
      'Histologic transformation to DLBCL',
      'Aquagenic pruritus from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein',
      'DIC in APL, treated with ATRA'
  ...
  // -------------------------- Multiple Myeloma --------------------------
  {
    ...
    sex:'any', ageMin:60, ageMax:82,
    pmhPool: ELDERLY_PMH, shxPool: ELDERLY_SHX,
    defect:'Clonal plasma-cell proliferation',
    ...
    diagnosticTest:'SPEP with M-spike; bone marrow biopsy',
    ...
    keyComplication:'Renal failure from cast nephropathy',
    complicationOptions:[
      'Renal failure from cast nephropathy',
      'Recurrent encapsulated infections from hypogammaglobulinemia',
      'Tumor lysis syndrome at chemotherapy initiation',
      'Aquagenic pruritus from JAK2 V617F',
      'DIC in APL, treated with ATRA'
    ],
  ...
  // -------------------------- Polycythemia Vera --------------------------
  {
    ...
    diagnosticTest:'JAK2 V617F; low serum EPO',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Thrombosis including Budd-Chiari syndrome',
    complicationOptions:[
  ...
  // -------------------------- Secondary Polycythemia --------------------------
  {
    ...
    diagnosticTest:'Serum EPO; JAK2 V617F negative',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Hyperviscosity thrombosis',
    complicationOptions:[
  ...
  // -------------------------- Adult T-cell Leukemia/Lymphoma --------------------------
  {
    ...
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'HTLV-1-driven CD4+ T-cell clone',
    ...
    diagnosticTest:'HTLV-1 serology; flow cytometry',
    ...
    keyComplication:'Severe hypercalcemia from PTHrP secretion',
    complicationOptions:[
      'Severe hypercalcemia from PTHrP secretion',
      'Aquagenic pruritus from JAK2 V617F',
      'Renal failure from cast nephropathy',
      'DIC in APL, treated with ATRA',
      'Hyperviscosity from monoclonal IgM paraprotein'
  ...
  // -------------------------- Mycosis Fungoides / Sézary --------------------------
  {
    ...
    sex:'any', ageMin:45, ageMax:75,
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'Clonal CD4+ cutaneous T-cell lymphoma',
    ...
    diagnosticTest:'Skin biopsy; TCR gene rearrangement',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Progression to tumor stage',
    complicationOptions:[
      'Progression to tumor stage',
      'Severe hypercalcemia from PTHrP secretion',
      'Renal failure from cast nephropathy',
      'DIC in APL, treated with ATRA',
      'Hyperviscosity from monoclonal IgM paraprotein'

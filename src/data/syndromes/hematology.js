...
export const SYNDROMES_HEME = [
  // -------------------------- AML --------------------------
  {
    ...
    defect:'Clonal myeloblast expansion; t(15;17) PML-RARA (APL), t(8;21) RUNX1-RUNX1T1, inv(16) CBFB-MYH11, FLT3-ITD, NPM1',
    ...
    diagnosticTest:'Bone-marrow biopsy (≥20% myeloblasts, MPO+, CD13/33/117+); cytogenetics/FISH for translocations',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'DIC in APL t(15;17) — treated with ATRA',
    complicationOptions:[
      'DIC in APL t(15;17) — treated with ATRA',
      'Tumor lysis syndrome at chemotherapy initiation',
      'Richter transformation to diffuse large B-cell lymphoma',
      'Blast crisis evolving to acute leukemia',
      'Hyperviscosity from monoclonal IgM paraprotein'
    ],
    cc: () => rand([
  ...
  // -------------------------- ALL --------------------------
  {
    ...
    defect:'Clonal lymphoblast expansion; t(12;21) ETV6-RUNX1 (best prognosis), t(9;22) BCR-ABL (poor prognosis), hyperdiploidy, MLL rearrangements',
    ...
    diagnosticTest:'Bone-marrow biopsy (≥20% lymphoblasts, TdT+; B-ALL: CD10/19/20+; T-ALL: CD3+)',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Tumor lysis syndrome at chemotherapy initiation (hyperuricemia, hyperkalemia, hyperphosphatemia, hypocalcemia)',
    complicationOptions:[
      'Tumor lysis syndrome at chemotherapy initiation',
      'DIC in APL t(15;17) — treated with ATRA',
      'Richter transformation to diffuse large B-cell lymphoma',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein'
    ],
    cc: () => rand([
  ...
  // -------------------------- CML --------------------------
  {
    ...
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'t(9;22) Philadelphia chromosome — BCR-ABL1 constitutively active tyrosine kinase',
    ...
    diagnosticTest:'Cytogenetics/FISH for t(9;22) Philadelphia chromosome; RT-PCR for BCR-ABL1',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Blast crisis — evolution to acute leukemia (myeloid ~70%, lymphoid ~30%), ≥20% blasts',
    complicationOptions:[
      'Blast crisis evolving to acute leukemia',
      'Richter transformation to diffuse large B-cell lymphoma',
      'Tumor lysis syndrome at chemotherapy initiation',
  ...
  // -------------------------- CLL --------------------------
  {
    ...
    defect:'Clonal CD5+/CD19+/CD23+ B-cell expansion; del(13q) most common, trisomy 12, del(11q) ATM, del(17p) TP53',
    ...
    diagnosticTest:'Peripheral-blood flow cytometry (CD5+/CD19+/CD20-dim/CD23+ B cells; ALC ≥5,000/μL)',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Richter transformation to diffuse large B-cell lymphoma',
    complicationOptions:[
      'Richter transformation to diffuse large B-cell lymphoma',
      'Warm AIHA and immune thrombocytopenia from autoantibodies',
      'Tumor lysis syndrome at chemotherapy initiation',
      'DIC in APL t(15;17) — treated with ATRA',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F'
    ],
  ...
  // -------------------------- Hairy Cell Leukemia --------------------------
  {
    ...
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'BRAF V600E somatic mutation — CD11c+/CD25+/CD103+/CD123+ B-cell clone; TRAP-positive',
    ...
    diagnosticTest:'Bone-marrow biopsy (TRAP+ "fried-egg" cells, dry tap); flow cytometry + BRAF V600E testing',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Pancytopenia from marrow infiltration — recurrent bacterial and atypical mycobacterial infections',
    complicationOptions:[
      'Pancytopenia with atypical mycobacterial infections from marrow infiltration',
      'Richter transformation to diffuse large B-cell lymphoma',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein',
      'DIC in APL t(15;17) — treated with ATRA'
  ...
  // -------------------------- Burkitt Lymphoma --------------------------
  {
    ...
    pmhPool: CHILD_HEALTHY_PMH, shxPool: CHILD_HEALTHY_SHX,
    defect:'t(8;14) MYC-IgH translocation — constitutive MYC overexpression; Ki-67 ~100%; variants t(2;8) and t(8;22)',
    ...
    diagnosticTest:'Excisional biopsy (starry-sky pattern, t(8;14) MYC-IgH, Ki-67 ~100%, BCL2-negative)',
    ...
    keyComplication:'Tumor lysis syndrome — may occur spontaneously before chemotherapy (prototypical lymphoma)',
    complicationOptions:[
      'Tumor lysis syndrome — Burkitt is the prototypical associated lymphoma',
      'Richter transformation to diffuse large B-cell lymphoma',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein',
      'DIC in APL t(15;17) — treated with ATRA'
  ...
  // -------------------------- Hodgkin Lymphoma --------------------------
  {
    ...
    defect:'Reed-Sternberg cells (CD15+/CD30+/CD45-/CD20-) in reactive inflammatory background; EBV-associated',
    ...
    diagnosticTest:'Excisional biopsy (Reed-Sternberg cells, CD15+/CD30+/CD45-/CD20-)',
    keyOrganism:'Epstein-Barr virus',
    ...
    keyComplication:'B symptoms (fever, night sweats, >10% weight loss) — Ann Arbor staging, worse prognosis',
    complicationOptions:[
      'B symptoms (fever, night sweats, ≥10% weight loss) — Ann Arbor staging, worse prognosis',
      'Tumor lysis syndrome (characteristic of Burkitt, not classical Hodgkin)',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein',
      'DIC in APL t(15;17) — treated with ATRA'
    ],
  ...
  // -------------------------- DLBCL --------------------------
  {
    ...
    pmhPool: ELDERLY_PMH, shxPool: ELDERLY_SHX,
    defect:'Aggressive large CD20+ B-cell lymphoma; BCL6 rearrangement; "double-hit" MYC+BCL2 subtype (worse prognosis)',
    ...
    diagnosticTest:'Excisional biopsy (sheets of large CD20+ B cells); FISH for MYC/BCL2/BCL6 ("double-hit")',
    keyOrganism:'',
    organismOptions:['Epstein-Barr virus','Human T-lymphotropic virus type 1 (HTLV-1)','Human herpesvirus 8 (HHV-8 / KSHV)','Helicobacter pylori'],
    keyComplication:'Transformation from an indolent lymphoma (Richter from CLL or follicular transformation)',
    complicationOptions:[
      'Transformation from an indolent lymphoma (Richter from CLL or follicular)',
      'Tumor lysis syndrome at chemotherapy initiation (especially double-hit disease)',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein',
      'DIC in APL t(15;17) — treated with ATRA'
    ],
  ...
  // -------------------------- Follicular Lymphoma --------------------------
  {
    ...
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'t(14;18) IgH-BCL2 translocation — constitutive BCL2 overexpression, impaired apoptosis of germinal-center B cells',
    ...
    diagnosticTest:'Excisional biopsy (follicular pattern, CD10+/BCL6+/BCL2+); FISH for t(14;18) IgH-BCL2',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Histologic transformation to DLBCL (~2–3% per year)',
    complicationOptions:[
  ...
  // -------------------------- Mantle Cell Lymphoma --------------------------
  {
    ...
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'t(11;14) IgH-CCND1 translocation — cyclin D1 overexpression, unregulated G1→S cell-cycle entry',
    ...
    diagnosticTest:'Excisional biopsy (CD5+/CD23-/cyclin D1+ nuclear); FISH for t(11;14) IgH-CCND1',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Lymphomatous polyposis — GI infiltration with multiple polypoid lesions',
    complicationOptions:[
      'Lymphomatous polyposis (GI polypoid infiltration)',
      'Tumor lysis syndrome at chemotherapy initiation',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein',
      'DIC in APL t(15;17) — treated with ATRA'
  ...
  // -------------------------- MALT Lymphoma --------------------------
  {
    ...
    sex:'any', ageMin:45, ageMax:75,
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'Extranodal marginal-zone B-cell lymphoma (MALT); antigen-driven; t(11;18) BIRC3-MALT1 predicts H. pylori eradication resistance',
    ...
    diagnosticTest:'Endoscopic biopsy (marginal-zone B cells, lymphoepithelial lesions); H. pylori testing; FISH for t(11;18)',
    ...
    keyComplication:'Failure to regress with H. pylori eradication when t(11;18) BIRC3-MALT1 is present',
    complicationOptions:[
      'Failure to regress with H. pylori eradication (t(11;18) BIRC3-MALT1 present)',
      'Histologic transformation to diffuse large B-cell lymphoma',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Hyperviscosity from monoclonal IgM paraprotein',
      'DIC in APL t(15;17) — treated with ATRA'
  ...
  // -------------------------- Multiple Myeloma --------------------------
  {
    ...
    sex:'any', ageMin:60, ageMax:82,
    pmhPool: ELDERLY_PMH, shxPool: ELDERLY_SHX,
    defect:'Clonal plasma-cell proliferation producing monoclonal Ig (IgG > IgA); free light chains; preceded by MGUS',
    ...
    diagnosticTest:'SPEP/UPEP M-spike + immunofixation; serum free light chains; bone-marrow biopsy (≥10% plasma cells); skeletal survey',
    ...
    keyComplication:'Renal failure from light-chain cast nephropathy ("myeloma kidney") — CRAB criteria',
    complicationOptions:[
      'Renal failure from light-chain cast nephropathy (CRAB)',
      'Recurrent encapsulated infections from functional hypogammaglobulinemia',
      'Tumor lysis syndrome at chemotherapy initiation',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'DIC in APL t(15;17) — treated with ATRA'
    ],
  ...
  // -------------------------- Polycythemia Vera --------------------------
  {
    ...
    pmhPool: ELDERLY_PMH, shxPool: ELDERLY_SHX,
    defect:'Acquired JAK2 V617F mutation (>95%) — EPO-independent erythroid proliferation; exon-12 JAK2 in others',
    ...
    diagnosticTest:'JAK2 V617F mutation testing + low serum EPO; bone-marrow biopsy (trilineage hyperplasia)',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Thrombosis including Budd-Chiari syndrome — leading cause of death in untreated PV',
    complicationOptions:[
      'Thrombosis including Budd-Chiari syndrome (leading cause of death in untreated PV)',
      'Recurrent encapsulated infections from functional hypogammaglobulinemia',
  ...
  // -------------------------- Secondary Polycythemia --------------------------
  {
    ...
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'Elevated EPO driving erythrocytosis — appropriate (COPD, sleep apnea, altitude) or inappropriate (EPO-secreting tumor: RCC, HCC, hemangioblastoma)',
    ...
    diagnosticTest:'Serum EPO (HIGH) + JAK2 V617F testing (NEGATIVE); workup for underlying cause (ABG, imaging)',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Hyperviscosity thrombosis — resolves with treatment of underlying cause',
    complicationOptions:[
      'Hyperviscosity thrombosis (resolves with treatment of underlying cause)',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Tumor lysis syndrome at chemotherapy initiation',
      'Renal failure from light-chain cast nephropathy',
      'DIC in APL t(15;17) — treated with ATRA'
  ...
  // -------------------------- Adult T-cell Leukemia/Lymphoma --------------------------
  {
    ...
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'Clonal CD4+ T-cell neoplasm driven by HTLV-1 (Tax/HBZ oncoproteins activate NF-κB)',
    ...
    diagnosticTest:'HTLV-1 serology (EIA + Western blot); flow cytometry (clonal CD4+/CD25+ T cells with flower cells)',
    ...
    keyComplication:'Severe hypercalcemia from tumor PTHrP secretion with lytic bone lesions',
    complicationOptions:[
      'Severe hypercalcemia from PTHrP secretion with lytic bone lesions',
      'Aquagenic pruritus and erythromelalgia from JAK2 V617F',
      'Renal failure from light-chain cast nephropathy',
      'DIC in APL t(15;17) — treated with ATRA',
      'Hyperviscosity from monoclonal IgM paraprotein'
  ...
  // -------------------------- Mycosis Fungoides / Sézary --------------------------
  {
    ...
    sex:'any', ageMin:45, ageMax:75,
    pmhPool: ADULT_PMH, shxPool: ADULT_SHX,
    defect:'Clonal CD4+ cutaneous T-cell lymphoma (Pautrier microabscesses in epidermis); Sézary = leukemic variant',
    ...
    diagnosticTest:'Skin biopsy (Pautrier microabscesses, clonal TCR rearrangement); flow cytometry (CD4+/CD7-/CD26- Sézary cells)',
    keyOrganism:'',
    organismOptions:[],
    keyComplication:'Progression to tumor-stage disease with bacterial skin superinfection; Sézary = worst prognosis',
    complicationOptions:[
      'Progression to tumor-stage disease with bacterial skin superinfection',
      'Severe hypercalcemia from PTHrP secretion with lytic bone lesions',
      'Renal failure from light-chain cast nephropathy',
      'DIC in APL t(15;17) — treated with ATRA',
      'Hyperviscosity from monoclonal IgM paraprotein'
